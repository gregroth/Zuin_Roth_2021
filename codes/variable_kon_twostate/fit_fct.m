%% fit_fct -- This function fits the variable kon two-state model to facs and fish data
%
% Inputs:
...
%constrain bounds 
lbtemp = [0;0;0;0;0;0];
ubtemp = [1000;1000;1000;1000;1;10];
lb = lbtemp(freeparam==1);
ub = ubtemp(freeparam==1);

%likelihood functions
MLF = @(x)MLtot_2state(freeparam,fixedparam,x,maxRna,dataVal,binsize,trdata_l,cpdata_l,cpfish);
